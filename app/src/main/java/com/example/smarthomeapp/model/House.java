...
public class House {
     ...
     */
    public House(String id, String name, String address, String phone, List<com.example.smarthomeapp.model.Floor> floorList, List<com.example.smarthomeapp.model.Division> divisionList) {
        this.id = id;
        this.name = name;
